...
<body>
	...
	<button type="button" id="about_button">About this demo</button>
		...
		<div style="float:left; margin-top: 30px; width:20%;background-color:gray;" id='ovunc'>sdadsa</div>
 		<div style="float:right; margin-top: 30px; width:80%;background-color:black;" id='calendar' ></div>
