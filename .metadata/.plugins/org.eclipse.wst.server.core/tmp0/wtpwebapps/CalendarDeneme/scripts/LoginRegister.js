function isEmpty( clicked_id){
	...
	if( clicked_id == "login_submit"){
		if( document.forms['login_form'].username.value == "" || document.forms['login_form'].username.value == "Username"){
		    ...
		    error = true;
		}if( document.forms['login_form'].password.value == "" || document.forms['login_form'].password.value == "Password"){
			document.getElementById("password_alert").style.visibility = 'visible';
	    	error = true;
		}
		return !error;
	}else{
		if( document.forms['register_form'].name.value == "" || document.forms['register_form'].name.value == "Name"){
		...
		if( document.forms['register_form'].surname.value == "" || document.forms['register_form'].surname.value == "Surname"){
		...
		if( document.forms['register_form'].email.value == "" || document.forms['register_form'].email.value == "E-mail"){
		...
		if( document.forms['register_form'].username.value == "" || document.forms['register_form'].username.value == "Username"){
